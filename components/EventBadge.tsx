...
// Interface for RigidBody ref that might have the custom `lerped` property added
interface RefRigidBody extends RapierRigidBody {
    lerped?: THREE.Vector3
}

useGLTF.preload('https://assets.vercel.com/image/upload/contentful/image/e5382hct74si/5huRVDzcoDwnbgrKUo1Lzs/53b6dd7d6b4ffcdbd338fa60265949e1/tag.glb')
useTexture.preload('/assets/badge/band.jpg')
useTexture.preload('/assets/badge/card.png')
...
function Band({ maxSpeed = 50, minSpeed = 10 }) {
    ...
    const j2 = useRef<RefRigidBody>(null)
    const j3 = useRef<RefRigidBody>(null)
    ...
    const texture = useTexture('/assets/badge/band.jpg')
    const cardTexture = useTexture('/assets/badge/card.png')
    useEffect(() => {
